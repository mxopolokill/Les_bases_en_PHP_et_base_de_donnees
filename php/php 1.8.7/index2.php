...
?>
    <div class="input-group mb-3" action="fonction/suppression.php">
    ...
    <form method="post" >
        <input class="form-control bg-primary text-white" type="text" name="name" value="<?php echo $donnees["Fav_Name"] ?>">
            ...
            <input type="hidden" name='delete' id='delete' value=" . $ligne['id'] . " />
                <button name='delete' id='delete' class="btn btn-secondary btn-sm">Supprimer</button>
    </form>
    <a href="./page_anexe/updatebook.php?id=<?php echo $donnees['id']?>">Editer</a>
